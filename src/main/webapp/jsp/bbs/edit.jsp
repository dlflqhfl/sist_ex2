...
<div id="bbs">
    <form action="Controller?type=edit" method="post"
        ...
        <table summary="게시판 수정">
            ...
            <tr>
                <th>제목:</th>
                <td><input type="text" name="title" data-str="제목" size="45" value="${bbs.subject}"/></td>
            </tr>
            <tr>
                <th>이름:</th>
                <td><input type="text" name="writer" data-str="이름" size="12" value="${bss.writer}"/></td>
            </tr>
            <tr>
                <th>내용:</th>
            ...
            <tr>
                ...
                <td><input type="file" name="file" data-str="첨부파일"/>
                    ...
                    %>--%>
                    <c:if test="${bbs.file_name != null}">
                        (${bbs.file_name})파일이 첨부된 상태
                    </c:if>
                    <%--    (<%=bbs.getFile_name()%>)파일이 첨부된 상태
                    <%
                        }
                    %>--%>
                </td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="button" value="목록"
                           onclick="javascript:location.href='Controller?type=list&bname=${param.bname}&cPage=${param.page}'"/>
                </td>
            </tr>
            </tbody>
        </table>
...
%>--%>
<c:if test="${empty bvo}">
    <c:redirect url="Controller?type=list"/>
</c:if>